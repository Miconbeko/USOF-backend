...
import {checkAdmin, checkLocked, checkOwner, checkTokenSession} from "../../middlewares/checkers.js";
...
router.put(`/:id`,              paramIdValidator, postCreationValidator, tokenValidator, validationErrorHandler, getDataFromToken, getUserByToken, checkTokenSession, checkAdmin, getPostById, getCategoriesByIds, PostsController.edit)
